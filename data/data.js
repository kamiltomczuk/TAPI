...
const characters = [
    {
      ...
      favoriteSpells: [{ id: '1', name: 'Expelliarmus', type: 'CHARM', description: 'Disarming Charm', level: 'EASY', effect: 'Disarms opponent' }],
    ...
    },
    {
        ...
        enemies: [{ character: { id: '3', firstName: 'Draco', lastName: 'Malfoy', fullName: 'Draco Malfoy' }, relationshipType: 'ENEMY' }],
        notableEvents: [{ name: 'Battle of Hogwarts', date: '1998-05-02', description: 'Final battle against Voldemort' }],
        favoriteSpells: [{ id: '2', name: 'Alohomora', type: 'CHARM', description: 'Unlocking Charm', level: 'EASY', effect: 'Unlocks doors' }],
